    ...
    <div class="row">
      <div class="col">
        ...
        <p class="fst-italic">
          ...
          maxime sunt inventore. Deleniti, porro doloremque quo inventore
          dolorum, aperiam, adipisci animi aut ipsam consequatur facilis fugiat
          excepturi soluta voluptates!
        </p>
      </div>
    </div>
  </div>
...
export default {
  ...
  computed: {
    photoImage() {
      return this.photoURL ? this.photoURL : "https://cdn5.vectorstock.com/i/thumb-large/45/79/male-avatar-profile-picture-silhouette-light-vector-4684579.jpg"
    }
  },
  methods: {
    async addContact() {
